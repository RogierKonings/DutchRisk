...
public class NedCardData {
	...
	private static Card cardantwerpen = new Card(1, CardType.CANNON, NedMapData.ANTWERPEN, cannonantwerpen, GameData.PLAYER_ONE);
	...
	private static Card cardoostvlaanderen = new Card(5, CardType.CANNON, NedMapData.OOST_VLAANDEREN, cannonoostvlaanderen, GameData.PLAYER_ONE);
	private static Card cardzeeland = new Card(6, CardType.CANNON, NedMapData.ZEELAND, cannonzeeland, GameData.PLAYER_TWO);
	
	private static Card carddrenthe = new Card(7, CardType.HORSE, NedMapData.ZEELAND, horsedrenthe, null);
	private static Card cardgelderland = new Card(8, CardType.HORSE, NedMapData.GELDERLAND, horsegelderland, GameData.PLAYER_TWO);
	private static Card cardhenegouwen = new Card(9, CardType.HORSE, NedMapData.HENEGOUWEN, horsehenegouwen, GameData.PLAYER_TWO);
	private static Card cardnamen = new Card(10, CardType.HORSE, NedMapData.NAMEN, horsenamen, null);
	private static Card cardnoordbrabant = new Card(11, CardType.HORSE, NedMapData.NOORD_BRABANT, horsenoordbrabant, GameData.PLAYER_TWO);
	...
	private static Card cardoverijssel = new Card(16, CardType.SOLDIER, NedMapData.OVERIJSSEL, soldieroverijssel, GameData.PLAYER_TWO);
